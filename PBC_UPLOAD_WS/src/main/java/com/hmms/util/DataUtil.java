...
public class DataUtil {
	...
	// TODO REGEX is not a good solution preventing sql injection,check every input
	// value,or use function in db to check them
	...
	/**
	 * check if sql query parameter is safe for sql
	 * 
	 * @return false if parameter is not safe for sql
	 * @param args
	 * @return
	 */
	public static boolean isSQLSafe(String... args) {
	...
	public static boolean isNotSQLSafe(String... args) {
		return !isSQLSafe(args);
	}
}
